...
/usr/local/spark/bin/spark-submit --master  spark://ec2-34-228-107-60.compute-1.amazonaws.com:7077 --py-files TextClassification.py  --packages com.databricks:spark-xml_2.10:0.4.1  ./wikiSparkES.py  